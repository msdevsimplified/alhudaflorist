            ...
            <div className="mx-auto max-w-screen-xl px-4 pt-4 pb-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="text-center sm:text-left">
                        <h3 className="text-base font-medium uppercase text-[#18181F] my-10">alhudaflorist</h3>
                        <p className='text-[#0c5b47]/80 transition hover:text-[#18181F]/75'>Your Premier Destination for Stunning Floral Arrangements in Dubai!</p>
                        <div className="mt-10">
                    <ul className="flex justify-center gap-6 sm:justify-start">
                        <li>
                            <a
                                ...
                                rel="noreferrer"
                                target="_blank"
                                className="text-[#18181F] transition hover:text-[#18181F]/75"
                            >
                    ...
                    <div className="text-center sm:text-left flex flex-col">
                        <p className=" text-base font-thin text-[#18181F]">FOLLOW OUR INSTRAGRAM</p>
