        ...
        <section className="container bg-white px-4 mx-auto">
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex items-center mt-4 gap-x-3">
                    ...
                    <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-[#FAFAD2] transition-colors duration-200 bg-blue-600 font-bold rounded-lg sm:w-auto gap-x-2 hover:bg-gray-600">
